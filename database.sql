...
INSERT INTO cars (image_path, category, name, capacity, description, rate) VALUES ('assets/images/Cars/PickUps/Ford Ranger.jpg', 'PickUps', 'Ford Ranger', '4-seater', 'The Ford Ranger is a versatile and capable pickup that is popular in Kenya. It has a spacious interior, a comfortable ride, and advanced features such as a terrain management system.', 21000),
 ...
 ('assets/images/Cars/SUV/Mitsubishi Pajero.jpg', 'SUV', 'Mitsubishi Pajero', '5-seater', 'The Mitsubishi Pajero is a rugged and reliable SUV that is well suited for off-road adventures. It is spacious, comfortable, and has a good resale value.', 25000),
 ...
 ('assets/images/Cars/SUV/Toyota Prado.jpg', 'SUV', 'Toyota Prado', '5-seater', 'The Toyota Land Cruiser Prado is a rugged and reliable SUV that is well suited for off-road adventures. It is spacious, comfortable, and has a good resale value.', 30000),
